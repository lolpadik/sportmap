...
async def startup():
    ...
    grounds = [
        ...
        SportsGround(name="ЦСК «Витебский»", sport_type="⚽ Футбол", city="Витебск",
                     address="пр-т Генерала Людникова, 12", latitude=55.1900, longitude=30.2100,
                     description="Центральный спортивный объект с полями и беговыми дорожками"),
        SportsGround(name="Школьный стадион СШ №46", sport_type="⚽ Футбол", city="Витебск",
                     address="ул. Богатырёва, 23", latitude=55.1800, longitude=30.2300,
                     description="Самый большой школьный спортивный комплекс в Билево"),
        SportsGround(name="Спортивная площадка у СШ №23", sport_type="🏋️ Воркаут", city="Витебск",
                     address="ул. Космонавтов, 10Б", latitude=55.2000, longitude=30.1900,
                     description="Крупный хаб: воркаут-рамы, турники, баскетбольная зона"),
        SportsGround(name="Дворовая площадка Чкалова", sport_type="🏋️ Воркаут", city="Витебск",
                     address="ул. Чкалова, 25/2", latitude=55.1950, longitude=30.2200,
                     description="Классические турники и брусья в жилом квартале"),
        SportsGround(name="Скейт-зона у Летнего Амфитеатра", sport_type="🛹 Скейтбординг", city="Витебск",
                     address="ул. Гоголя, 14", latitude=55.1920, longitude=30.2050,
                     description="Уличные перила и парапеты для скейтеров"),
        SportsGround(name="Скейт-парк Герцена", sport_type="🛹 Скейтбординг", city="Витебск",
                     address="ул. Герцена, 20А", latitude=55.1850, longitude=30.2150,
                     description="Специализированный скейт-парк"),
        SportsGround(name="Ледовый дворец Витебск", sport_type="🏒 Хоккей", city="Витебск",
                     address="пр-т Строителей, 23", latitude=55.2000, longitude=30.1800,
                     description="Крытый лед"),
        SportsGround(name="Корты ЦСК Витебск", sport_type="🎾 Теннис", city="Витебск",
                     address="пр-т Генерала Людникова, 12", latitude=55.1900, longitude=30.2100,
                     description="Открытые теннисные площадки"),
        SportsGround(name="ЦСК «Витебский» бег", sport_type="🏃 Бег", city="Витебск",
                     address="пр-т Генерала Людникова, 12", latitude=55.1900, longitude=30.2100,
                     description="Легкоатлетическое ядро для бега"),
        SportsGround(name="Школьный стадион СШ №46 волейбол", sport_type="🏐 Волейбол", city="Витебск",
                     address="ул. Богатырёва, 23", latitude=55.1800, longitude=30.2300,
                     description="Волейбольные зоны в школьном комплексе"),
    ]
    db.add_all(grounds)
    db.commit()
    db.close()
